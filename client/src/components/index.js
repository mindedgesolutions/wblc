...
export { default as ActivatePermission } from "./rolesPermissions/ActivatePermission";
export { default as DeleteRole } from "./rolesPermissions/DeleteRole";
export { default as DeletePermission } from "./rolesPermissions/DeletePermission";
